...
print(df['is_aftershock'].value_counts())
...
joblib.dump(xgboost_model_instance, 'xgboost_smote_model.pkl')
...
print("Önce (Eğitim Seti):")
print(y_train.value_counts())
print("Sonra (SMOTE Sonrası Eğitim Seti):")
...
print("Test Sonuçları (GridSearch sonrası XGBoost):")
print(classification_report(y_test, y_pred, target_names=["Artçı Değil", "Artçı"]))
